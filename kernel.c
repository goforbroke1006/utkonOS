...
void kernel_entry() {
    ...
    vga_buffer[14] = vga_entry('o', WHITE, BLACK);
    vga_buffer[15] = vga_entry('m', WHITE, BLACK);
    vga_buffer[16] = vga_entry(' ', WHITE, BLACK);
    vga_buffer[17] = vga_entry('u', RED, WHITE);
    vga_buffer[18] = vga_entry('t', RED, WHITE);
    vga_buffer[19] = vga_entry('k', RED, WHITE);
    vga_buffer[20] = vga_entry('o', RED, WHITE);
    vga_buffer[21] = vga_entry('n', RED, WHITE);
    vga_buffer[22] = vga_entry('O', BLACK, WHITE);
    vga_buffer[23] = vga_entry('S', BLACK, WHITE);
}